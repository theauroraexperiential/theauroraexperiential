...
const BookingCTA = () => {
  return (
    <section id="booking" className="py-24 relative z-10 border-t border-charcoal-800 overflow-hidden bg-charcoal-900">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-20">
        ...
        <div className="bg-charcoal-800/80 backdrop-blur-md rounded-3xl p-8 md:p-12 border border-charcoal-700 shadow-2xl relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-8 text-left">
              ...
              <div className="space-y-6">
                ...
                <a href="mailto:theauroraexperiential@gmail.com" className="flex items-center gap-4 text-white hover:text-gold-400 transition-colors group">
                  <div className="w-12 h-12 bg-charcoal-900 rounded-full flex items-center justify-center border border-charcoal-700 group-hover:border-gold-500/50">
                    <Mail size={20} className="text-gold-500" />
                  </div>
                  <div>
                    <div className="text-xs text-slate-500 font-medium mb-1">Email</div>
                    <div className="font-semibold text-base sm:text-lg">theauroraexperiential@gmail.com</div>
                  </div>
                </a>
              </div>
            </div>

            <div className="bg-charcoal-900 p-8 rounded-2xl border border-charcoal-700 flex flex-col justify-center h-full">
